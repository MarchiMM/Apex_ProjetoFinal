...
using ProjetoFinal_API.Data.Repository;
...
namespace ProjetoFinal_API
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<IRepositoryRequest, RepositoryRequest>();
            services.AddScoped<IRepositoryTaxation, RepositoryTaxation>();
        }
